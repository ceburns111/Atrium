...
- REVIEW SEMANTIC LAYER CODE FROM WORK. DESIGN BASIC EXAMPLE HERE, CONSIDER HOW YOU WOULD HAVE MULTIPLE SERVICES CONTRIBUTE/HANDLE MULTIPLE TEAMS
...
- DO i need to organize Atrium.Design (A lotta stuff in root)?
