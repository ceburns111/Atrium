...
**Tests (unit).** References the projects under test directly and runs their logic without spinning up the app or its dependencies. Currently 57 tests across all modules and services.
