...
**Read [AGENTS.md](AGENTS.md) first** — it is the orientation hub. Authoritative detail lives in [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md) (how it fits), [docs/adr/](docs/adr/README.md) (why, 0001–0013), and [docs/guides/wire-up-a-new-app.md](docs/guides/wire-up-a-new-app.md) (the end-to-end procedure for adding a full vertical).
